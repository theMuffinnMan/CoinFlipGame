...
public class main
{
    ...
    public static void main (String[] args)
    {
        ...
        while(coin1.getPoints() < 3 && coin2.getPoints() < 3){
            coin1.flip();
            coin2.flip();
            System.out.println(coin1.getColour() + " : " + coin1.getFaceValue());
            System.out.println(coin2.getColour() + " : " + coin2.getFaceValue());
            System.out.println(coin1.getColour() + " : " + coin1.getPoints() + " Points");
            System.out.println(coin2.getColour() + " : " + coin2.getPoints() + " Points");
            System.out.println();
